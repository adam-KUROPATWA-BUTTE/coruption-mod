...
public class ModBlocks {
    ...
    CORRUPTED_DIRT = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "corrupted_dirt"), new com.corruptionmod.block.CorruptedDirtBlock());
        ...
        // Void Realm dimension blocks
        VOID_STONE = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "void_stone"), new VoidStoneBlock());
        CORRUPTION_FLESH = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "corruption_flesh"), new CorruptionFleshBlock());
        OBSIDIAN_CRUST = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "obsidian_crust"), new ObsidianCrustBlock());
        TWISTED_LOG = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "twisted_log"), new TwistedLogBlock());
        BLIGHTED_GRASS = Registry.register(Registry.BLOCK, new Identifier(CorruptionMod.MOD_ID, "blighted_grass"), new BlightedGrassBlock());
    }
}
